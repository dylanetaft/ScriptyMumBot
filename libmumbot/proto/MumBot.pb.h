...
class TextMessageRequest : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:libmumbot.TextMessageRequest) */ {
 public:
  TextMessageRequest();
  ...
  // @@protoc_insertion_point(class_scope:libmumbot.TextMessageRequest)
 private:
...
class TextMessageResponse : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:libmumbot.TextMessageResponse) */ {
 public:
  TextMessageResponse();
  ...
  // @@protoc_insertion_point(class_scope:libmumbot.TextMessageResponse)
 private:
...
class TextMessage : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:libmumbot.TextMessage) */ {
 public:
  TextMessage();
  virtual ~TextMessage();
  ...
  // @@protoc_insertion_point(class_scope:libmumbot.TextMessage)
 private:
